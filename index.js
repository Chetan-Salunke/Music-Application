...
function playSong(songName) {
    ...
    if (songName === 'song1') {
        audio.src = './songs/Arjan Vailly Animal 128 Kbps.mp3';
    } else if (songName === 'song2') {
        audio.src = './songs/Softly-(PagalWorld).mp3';
    }
    else if (songName === 'song3') {
        audio.src = './songs/Jamal Kudu - Animal-(PagalWorld.Com.IN).mp3';
    }
    else if (songName === 'song4') {
        audio.src = './songs/Obsessed(PagalWorld.com.pe).mp3';
    }
